...
applyButtons.forEach(button => {
    button.addEventListener('click', () => {
        ...
        const targetPosition = applySection.offsetTop - navbarHeight;
...
careersForm.addEventListener('submit', async (e) => {
    ...
    try {
        ...
        showNotification('Failed to submit application. Please email your resume to careers@synetica.com', 'error');
    } finally {
